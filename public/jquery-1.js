...
(function () {
    ...
    jQuery.extend({
        ...
        grep: function (elems, callback, inv) {
            if (typeof callback == "string") callback = eval("false||function(a,i){return " + callback + "}");
            var ret = [];
    ...
    jQuery.event = {
        ...
        remove: function (elem, types, handler) {
            ...
            var events = jQuery.data(elem, "events"),
                ret, index;
            if (events) {
                if (types == undefined) for (var type in events) this.remove(elem, type);
                else {
                    if (types.type) {
...
// Function to retrieve the part of the url after the # sign
